import { Shield, LayoutDashboard, MessageCircle, Download } from 'lucide-react';
    ...
    <aside style={{
      ...
      <div style={{ padding: '0 1.5rem', marginBottom: '2.5rem' }}>
        <div className="d-flex align-items-center">
          ...
          <span style={{ fontWeight: '700', fontSize: '1.1rem', color: '#0A0A0A' }}>Wait</span>
        </div>
      </div>
          ...
          return (
            <a
              ...
              style={{
                ...
                borderRadius: '8px',
                textDecoration: 'none',
                color: isActive ? '#E31C79' : '#666',
                background: isActive ? 'rgba(227,28,121,0.08)' : 'transparent',
